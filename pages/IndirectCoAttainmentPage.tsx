...
import { Course, CO } from '../types';

type CoRatings = Record<string, Record<string, number | string>>;
...
const IndirectCoAttainmentPage = () => {
    ...
    const [coRatings, setCoRatings] = useState<CoRatings>({});
    
    // Initialize with mock data
    useEffect(() => {
        const initialRatings: CoRatings = {};
    ...
    const handleRatingChange = (coId: string, value: string) => {
